        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-green-50 dark:bg-green-900/30 overflow-hidden shadow-sm sm:rounded-lg border-l-4 border-green-500">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <p class="text-sm">Berdasarkan data mining historis yang ada, Lonjakan pengunjung paling sering terjadi pada minggu ke-4 (akhir bulan) dan sebagian pada minggu ke-1, terutama di bulan Juni, Juli, November, dan Desember (pada periode liburan). Fokuskan penambahan staf tiket pada periode dengan label "Peak Demand".</p>
                </div>
            </div>
